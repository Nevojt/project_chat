...
async def upload_to_avatars(file: UploadFile = File(...), bucket_name: str = "image_avatars"):
    """
...
async def upload_to_rooms(file: UploadFile = File(...), bucket_name: str = "image_rooms"):
    """
    This function is used to upload a file to supabase storage.
